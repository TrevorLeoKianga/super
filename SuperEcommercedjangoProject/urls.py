...
urlpatterns = [
    ...
    path('add-products/', user_views.add_product, name='add-product-page'),
    path('products/', user_views.all_products, name='all-products'),
    path('del-product/<id>', user_views.delete_product, name='delete-product'),
    path('update-product/<id>', user_views.update_product, name='update-product'),
